const MiniReact = (function () {
    ...
    const render = function (vdom, container, oldDom = container.firstChild) {
        // First time render
        if (!oldDom) {
            // helper function to help with readability
    ...
    // vdom (at this point) is the structure in div tag stored in Step 1 component
    // container is the entry point of the application - the div elements with id of root
